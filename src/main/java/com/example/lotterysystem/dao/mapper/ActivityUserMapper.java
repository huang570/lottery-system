...
public interface ActivityUserMapper {
    ...
    List<ActivityUserDO> seleceByActivityId(@Param("activityId") Long activityId);
    ...
    @Select("<script>" +
            ...
            " </foreach>" +
            " </script>")
    List<ActivityUserDO> batchSelectByAUIds(@Param("activityId") Long activityId,@Param("userIds") List<Long> userIds);
