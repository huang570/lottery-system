...
public interface ServiceErrorCodeConstants {
    ...
    ErrorCode VERIFICATION_CODE_ERROR = new ErrorCode(111,"验证码校验错误");
    ...
    ErrorCode USER_PRIZE_AMOUNT_ERROR = new ErrorCode(303,"活动关联的奖品及人员数量异常");
    ...
    ErrorCode WINNER_PRIZE_AMOUNT_ERROR = new ErrorCode(403,"中奖者人数与奖品数量有误, 无法抽奖");
